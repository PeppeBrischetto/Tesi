...
\usepackage[inner=3.5cm, outer=4.35cm]{geometry}
%\usepackage[inner=2.0cm, outer=3.0cm, bindingoffset=2.0cm]{geometry} %Margini di Ale
\setlength\topmargin{20pt}
\setlength\textwidth{390.0pt}
\setlength\textheight{548.5pt}
...
\chapter{\iflanguage{italian}{Validazione della simulazione}{Validation of simulation}}
\input{capitolo4.tex}
