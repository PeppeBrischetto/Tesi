...
\begin{figure} [!p]
	...
	\caption{Le correlazioni $x_{foc} - E_{CsI}$ ottenute, durante il test, dalla misura in correlazione del tracciatore e del rivelatore allo CsI . La linea nera indica il taglio grafico effettuato per la selezione in numero atomico dell'\ce{^{16}O}. \textcolor{red}{Taglio da aggiustare}} \label{fig:xfoc2_csi_standard}
\end{figure}
