...
Un prototipo di dimensioni ridotte, mostrato in Figura, è stato realizzato per individuare le migliori soluzioni in termini di geometria, tensioni applicate, MPGD ed elettronica.  

\textcolor{red}{Aggiungere parte sul castelletto e la sua foto}
...
Poiché la resistenza alle radiazioni è l'aspetto di maggiore importanza per la scelta dei rivelatori da utilizzare per NUMEN, alcune simulazioni Monte Carlo sono state implementate allo scopo di valutarla nel caso dei rivelatori al SiC. 
