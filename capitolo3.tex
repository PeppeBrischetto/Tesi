...
Tali valori, arrotondati verso l'alto per ottenere delle stime prudenti, sono stati ricavati da misure sperimentali svolte dalla collaborazione NUMEN (si vedano, ad esempio, \textcolor{red}{inserire ref}).
...
È bene precisare che, per l'\ce{^{19}O}, il valore indicato non deriva da misure sperimentali ma da considerazioni sull'ordine del processo stesso in relazione ad altri processi di trasferimento di nucleoni di cui è nota la sezione d'urto.
\begin{table} [p!]
	\begin{center}
		\renewcommand{\arraystretch}{1.2}
...
A partire da questo valore è possibile risalire alla sensibilità di misura nel modo seguente: sapendo che la sezione d'urto tipica del DCE nel range di energia di eccitazione studiato è di circa 1000~nb (si veda, ad esempio, \textcolor{red}{inserire ref}), dal rapporto S/B si deduce che il fondo corrisponde a circa 40~pb ad 1$\sigma$ di errore; dunque, considerando 5$\sigma$, si trova una sensibilità di circa 200~pb.
