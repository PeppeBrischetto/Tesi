...
\end{figure}
Per dare una stima quantitativa della percentuale di eventi degradati che potrebbero 
...
\begin{table} [p!]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{I valori tipici delle sezioni d'urto sperimentali di diversi processi di reazion nucleari normalizzate alla sezione d'urto del DCE.} \label{tab:sez_d'urto}
\end{table}
