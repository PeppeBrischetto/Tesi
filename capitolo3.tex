...
\begin{figure} [!t]
	...
	\caption{L'andamento della probabilità di identificare nuclei \ce{^{18}Ne} come \ce{^{18}O} al variare della superficie del rivelatore e per energie pari a 450 e 850~MeV. I punti si riferiscono ai tre valori di superficie considerati nelle simulazioni.} \label{fig:misident_vs_surface}
\end{figure}
...
In tutti e tre i casi, i telescopi avevano dimensioni trasversali pari a $1.5 \times 1.5$~cm\ap{2}, mentre lo spessore del substrato morto è di 350~$\mu$m.
