...
Per quanto riguarda il primo caso, i plot di riferimento sono quelli mostrati nel paragrafo precedente.
Nel secondo, come si può notare dalla Figura~, le matrici $\Delta E_{SiC} - E_{CsI}$
