...
\begin{table} [t!]
	\begin{center}
		...
		\begin{tabular} {cccc}
			...
			\toprule[0.1em]
			%\hline
			\ce{^{18}F^{9+}} & & & 0.1 $\pm$ 0.01 \\
			\ce{^{19}F^{9+}} & & & 0.1 $\pm$ 0.01 \\
		\end{tabular}
	\end{center}
...
\end{table}
La contaminazione più rilevante deriva dal \ce{^{20}F^{9+}} e dal \ce{^{20}Ne^{10+}}, come era lecito aspettarsi considerando che si tratta delle specie ioniche che hanno un valore di $\Delta E_{SiC}$ molto simile a quello dell'\ce{^{20}O^{8+}}.
...
Tuttavia, nella situazione reale la produzione degli ioni considerati avviene attraverso meccanismi di reazioni nucleari, ciascuno caratterizzato da una certa sezione d'urto.
