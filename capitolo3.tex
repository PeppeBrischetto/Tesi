...
Mettendo insieme i depositi di energia di tutti gli eventi, si riproduceva lo spettro energetico degli ioni nei due stadi del telescopio.
A questo livello, soltanto le fluttuazioni statistiche legate alla ionizzazione erano tenute in considerazione.
Dunque, al fine di riprodurre le risoluzione energetiche tipiche dei rivelatori in esame, lo spettro energetico è stato ``allargato'' campionando ciascun deposito di energia con una distribuzione gaussiana, la cui espressione è
%\begin{equation}
%	f(E) = A \, \mbox{e}^{- \frac{E - E_0}{2 {\sigma}^2}}
%\end{equation}
\begin{equation}
	f(E) = A \, \exp \left( \frac{E - E_0}{2 {\sigma}^2} \right)
\end{equation}
...
\end{equation}
la deviazione standard risulta 
