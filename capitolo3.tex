...
In tutti i casi esaminati gli ioni sono stati considerati completamente ionizzati.
...
Dunque, la relazione fra $x_{foc}$ ed $E$ è circa quadratica e dipende dal rapporto $\sqrt{m}/q$, ovvero
...
La dipendenza della \ref{eq:legge_spettrometri_approx} dal rapporto $\sqrt{m}/q$ costituisce il fondamento di una innovativa tecnica di identificazione per spettrometri di grande accettanza; se, infatti, si misurano in correlazione la posizione $x_{foc}$ e l'energia cinetica $E$, è possibile identificare gli ioni in massa e stato di carica.
