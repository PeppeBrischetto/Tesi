...
\begin{figure} [!p]
	\centering
	\subfigure[]
	{\includegraphics[scale=0.48]{Grafici_Tesi2/Particelle_non_ortogonali/deltaE.png}}
	\hspace{10mm}
	\subfigure[]
	{\includegraphics[scale=0.48]{Grafici_Tesi2/Particelle_non_ortogonali/ETot.png}}

	\caption{Le proiezioni della matrice $\Delta E_{SiC} - E_{meas}$ di Figura~\ref{fig:deltaE_ETot_full_energy}: in (a) sull'asse $\Delta E_{SiC}$, in (b) sull'asse $E_{meas}$.} \label{fig:fetta}
\end{figure}
...
A differenza dei casi precedenti, si sono simulati nove ioni, ovvero \ce{^{18}O}, \ce{^{19}O}, \ce{^{20}O}, \ce{^{18}F}, \ce{^{19}F}, \ce{^{20}F}, \ce{^{18}Ne}, \ce{^{19}Ne} e~\ce{^{20}Ne}.
...
Per fissare la rigidità magnetica di riferimento si è scelto il \ce{^{18}Ne}, che fra gli ioni considerati è quello con il rapporto massa su carica più piccolo.
...
Questa considerazione è confermata dalla Figura~\ref{fig:KinE}, in cui viene riportato lo spettro delle energie cinetiche dei diversi ioni.
...
%	\caption{Taglio grafico per l'identificazione del~\ce{^{20}O}.} \label{fig:deltaE_Emeas_taglio}
%\end{figure}
