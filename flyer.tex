...
Dalla simulazione è emerso che il principale contaminante allo ione di interesse (\ce{^{20}O}) è il \ce{^{20}F^{8+}}, il quale è originato da un processo di singolo scambio di carica.
