...
\begin{figure} [!h]
	\centering
	\includegraphics[width=0.9\columnwidth, keepaspectratio]{Grafici/magnex_etichette.png}
\end{figure}
%\begin{center}
...
Dalla simulazione è emerso che, nello studio di una reazione di DCE a bassa energia di eccitazione, il principale contaminante allo ione di interesse (\ce{^{20}O}) è il \ce{^{20}F^{8+}}, il quale è originato da un processo di singolo scambio di carica.
